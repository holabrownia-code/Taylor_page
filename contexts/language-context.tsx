...
const translations = {
  es: {
    ...
    // Suggestions Page
    suggestionsTitle: "Tus Ideas Hacen la Magia",
    suggestionsSubtitle: "¡Ayúdanos a hacer de este el mejor lugar para Swifties!",
    formName: "Nombre o Alias Swiftie (Opcional)",
    formEmail: "Correo Electrónico",
    formEmailPrivacy: "Solo usaremos tu correo para contactarte sobre tu sugerencia si es necesario.",
    formType: "Tipo de Sugerencia",
    formTypeImprovement: "Mejora del Juego Actual",
    formTypeNewGame: "Nuevo Tipo de Juego",
    formTypeOther: "Otra Sugerencia/Comentario General",
    formTitle: "Título/Resumen",
    formDetails: "Detalles de la Sugerencia",
    formDifficulty: "Nivel de Dificultad Deseado (Opcional)",
    formDifficultyEasy: "Fácil",
    formDifficultyMedium: "Medio",
    formDifficultyHard: "Swiftie Hardcore",
    submit: "Enviar Sugerencia",
    submitting: "Enviando...",
    successMessage: "¡Gracias! Tu sugerencia ha sido enviada a nuestro Mastermind.",
  },
  en: {
    ...
    poweredBy: "Powered by",
    // Suggestions Page
    suggestionsTitle: "Your Ideas Make Magic",
    suggestionsSubtitle: "Help us make this the best place for Swifties!",
    formName: "Swiftie Name or Alias (Optional)",
    formEmail: "Email",
    formEmailPrivacy: "We will only use your email to contact you about your suggestion if necessary.",
    formType: "Suggestion Type",
    formTypeImprovement: "Improvement to Current Game",
    formTypeNewGame: "New Game Type",
    formTypeOther: "Other Suggestion/Comment",
    formTitle: "Title/Summary",
    formDetails: "Suggestion Details",
    formDifficulty: "Desired Difficulty Level (Optional)",
    formDifficultyEasy: "Easy",
    formDifficultyMedium: "Medium",
    formDifficultyHard: "Hardcore Swiftie",
    submit: "Submit Suggestion",
    submitting: "Submitting...",
    successMessage: "Thank you! Your suggestion has been sent to our Mastermind.",
  },
}
